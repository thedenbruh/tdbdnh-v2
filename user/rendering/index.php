...
include('../../site/PHP/helper.php');
  ...
  if(base64_decode($image64)) {
    ...
    $ID = $id;
    $imageFile = fopen("../../assets/images/avatars/$ID.png", "w") or die("Unable to write avatar!");
    $data = $img;
    if ($imageFile) {
      ...
      if ($writeImage) {
        ...
        ?> <script> window.location = "/assets/images/avatars/<?php echo $ID; ?>.png?c=<?php echo rand() ?>"; </script>
        <?php
        die();
...
//uv map of it
 ...
 setTimeout(function(){
      ...
      v44ar523rIs3cRet = canvas.toDataURL("image/png");
      goDEESNuTzLoLd0nutZE = v44ar523rIs3cRet.substr(22);
      document.getElementById('img').value = goDEESNuTzLoLd0nutZE; 
      document.forms[0].submit();
          },<?php echo 2000 * ($coolVar4CoolPeople+1); ?>);
      //funny mess with dataimg which patches the not so funny vuln from 2017
    </script>
  <script>
    if(XMLHttpRequest)
{
