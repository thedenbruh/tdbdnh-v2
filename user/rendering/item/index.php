...
include('../../../site/PHP/helper.php');
  ...
  if(base64_decode($image64)) {
    ...
    $ID = $id;
    $imageFile = fopen("../../../assets/images/headshots/$ID.png", "w") or die("Unable to write avatar!");
    $data = $img;
    if ($imageFile) {
      ...
      if ($writeImage) {
        ...
        ?> <script> window.location = "/assets/images/headshots/<?php echo $ID; ?>.png?c=<?php echo rand() ?>"; </script>
        <?php
        die();
...
<html>
  ...
  <body>
    <img src="/assets/GeneratingAvatar.png" style="height: 210px;padding-top: 15px;margin-left: -25px;">
    <canvas id="avatarCanvas" width="165px" height="210px" style="display:none;"></canvas>
...
//uv map of it
    ...
    // modified by isaiah - 1/8/2017 6:30PM-7:00PM EST
      ...
      hAhz3241Yaes = canvas.toDataURL("image/png");
      hAhzYaes = hAhz3241Yaes.substr(22);
      //dataimg vuln fix
      document.getElementById('img').value = hAhzYaes; 
