...
include('../../../site/PHP/helper.php');
  ...
  'torso_color' => 'ffffff','left_leg_color' => 'd1d1d1','right_leg_color' => 'd1d1d1','left_arm_color' => 'f3b700','right_arm_color' => 'f3b700','head_color' => 'ffffff','head' => 0);
  ...
  <body>
   ...
   // directionalLight.position.set( 0, 2, 1 );
    scene.add( directionalLight );
        ...
        loader.load( '<?php if($avatar->{"head"} > 0) { echo "/shop/assets/heads/"; ?><?php echo $avatar->{"head"}; ?><?php echo ".obj" ;} else { echo "face.obj"; } ?>', function ( head ) {
