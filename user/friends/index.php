...
<html>
	...
	<head>
		<title>Friends - plutonium</title>
	</head>
	
	<body>
		<div id="body">
			<div id="column" style="float:left; width:50%;">
			<div id="box">
				...
				<?php 
    					...
    					while($requestsData = mysqli_fetch_assoc($requests)) {
        					...
        					<div style='margin:10px;'>
        						<div style='padding:2px;float: left;'>
        							<img src='/assets/images/avatars/$otherUser[id].png?c=".$otherUser['avatar_id']."' width='130px'><br>
					...
					echo '</div></div></div></div><div id="column" style="float:right; width:33%;"><div id="box"><div id="friends">
					...
					if (mysqli_num_rows($friendsList) > 0) {
							...
							$friendRowQ = mysqli_query($conn,"SELECT * FROM `beta_users` WHERE (`id`='$friendsListRow[from_id]' OR `id`='$friendsListRow[to_id]') AND `id`!='$userID'");
		    					...
		    					echo "
		    						<div style='margin:10px;'>
		        						<div style='padding:2px;float: left;'>
		        							<img src='/assets/images/avatars/$friendRow[id].png?c=".$friendRow['avatar_id']."' width='130px'><br>
