...
<!DOCTYPE html>
  <head>
    <title>Upload Shirt - plutonium</title>
  </head>
  <body>
    <div id="body">
      <div id="box">
        ...
        <div style="float:left;">
          <form style="margin:10px;" action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="file" accept="image/*" id="file" name="image" style="margin-bottom:10px;" onchange="loadFile(event)"><br>
        ...
        <img src="template.png" style="float:right;width:50%;height:50%px;margin:10px;" id="output" />
      </div>
    </div>
  </body>
</html>
