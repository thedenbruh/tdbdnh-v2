...
<div id="box" style="padding: 5px;">
        <div id="subsect">
          ...
          while($shopRow = $shopImage->fetch_assoc()) {
              ...
              echo '<div style="text-align:center;padding:4px;"><div><div style="width:35%;float:left;text-align:center;"><img style="width:250px;" src="/shop/assets/'.$type.'/'.shopItemHash($itemID).'.png"></div><div style="width:35%;float:left;text-align:center;"><img style="width:250px;" src="/shop_storage/thumbnails/'.$itemID.'.png"></div>';
          ...
          while($clanRow = $clanLogoQuery->fetch_assoc()) {
              $clanID = $clanRow['id'];
              echo '<div id="subsect" style="overflow:auto;">';
              echo '<div style="text-align:center;padding:4px;"><div><div style="width:50%;float:left;text-align:center;"><img style="width:250px;" src="/images/clans/'.$clanID.'.png"></div>';
