<?php
 ...
 /*   include("/usr/home/thedenbruh1/domains/thedenbruh1.ct8.pl/public_html/site/PHP/helper.php");*/
  ...
  <div id="body">
    <div id="column" style="float:left; width:195px;">
        <div id="box" style="padding-bottom:0px;">
          <div id="subsect">
            <h3 style="padding:5px;">admin panel</h3>
          </div>
    ...
    <?php 
	  ...
	  "PHP Information" => "/admin/pages/phpinfo",
	  "Invite Key Generation" => "/admin/pages/keys",
          );
